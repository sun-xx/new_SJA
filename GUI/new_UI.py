...
__author__ = ['GuYan1024', 'gitkunkun', 'sun-xx']
    ...
    while True:  # 主循环
        for e in pygame.event.get():
            ...
            if e.type == pygame.MOUSEBUTTONDOWN:  # 鼠标事件
                ...
                # print(pos)  # 测试用
                if pos[0] > 0 and pos[0] < 250 and pos[1] > 120 and pos[1] < 180:
                    update(focus='add_file')  # 按下选择文件
                    state = 'add_file'
                elif pos[0] > 0 and pos[0] < 250 and pos[1] > 210 and pos[1] < 270:
                    update(focus='report')  # 按下报告
                    state = 'report'
                elif pos[0] > 0 and pos[0] < 250 and pos[1] > 290 and pos[1] < 360:
                    update(focus='setting')  # 按下设置
                    state = 'setting'
                elif pos[0] > 470 and pos[0] < 620 and pos[1] > 190 and pos[1] < 350:
